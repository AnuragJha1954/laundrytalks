"""
Django settings for laundrytalks project.
...
SECRET_KEY = 'django-insecure-9*ywbtg$-n2f0dw(q0-+6t*xhjnic0^r_!pji2rzmms%&%_z6!'
...
ROOT_URLCONF = 'laundrytalks.urls'
...
WSGI_APPLICATION = 'laundrytalks.wsgi.application'
